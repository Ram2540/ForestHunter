...
//     //   if (hero) {
//     //     this.controllerActions.HeroLoad(hero);
//     //     // console.log('this.superHero.next(hero);');
...
//     //   }
//     // });
//     //setInterval(() => { this.store.dispatch(new fromEnemyActions.EnemyIsDamaged(this.damage)); }, 100);
//     setInterval(() => { 
//       //this.store.dispatch(new fromEnemyActions.EnemyIsDamaged(this.damage));
//       controllerActions.EnemyIsDamaged(this.damage);
//     }, 1000);
